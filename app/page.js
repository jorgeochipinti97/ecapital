      ...
      <section>
        <div className="flex justify-center flex-col items-center">
          ...
          >
            ...
            <span className="text-violet-400 font-bold"> MUNDO!</span>
          </p>
          <p className="font-geist text-md uppercase w-10/12 md:w-8/12 font-semibold  mt-10 text-[#f5f5f7]  text-center">
